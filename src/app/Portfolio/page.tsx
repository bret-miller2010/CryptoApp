...
export default function Portfolio() {
   ...
   return (
      <div className={`text-white ${darkMode ? "duration-300 bg-black" : "duration-300 bg-[#bfbfbf]"} h-screen`}>
         <div className="flex flex-col">
            <div className="flex justify-between px-2.5 mt-10 ">
               <p className={`flex justify-center items-center h-[30px] ${darkMode ? "duration-300 bg-[#474792]" : "duration-300 bg-[#5492f7]"} px-10 rounded-full`}>
                  Your Portfolio
               </p>
               {login && (
                  <Link
            ...
            <div className={`flex items-center flex-col rounded-3xl ${darkMode ? "duration-300 bg-[#181825]" : "duration-300 bg-[#5492f7]"} py-5 space-y-5 mt-5`}>
