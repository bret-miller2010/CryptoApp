...
const BottomCoinList = ({ data, spot, darkMode, width }) => {
    ...
    return (
        <div className={`flex justify-between hover:scale-105 duration-300 ${textColor(darkMode)} p-1 rounded-2xl ${secondaryColor(darkMode)} h-[50px] min-[800px]:h-[65px] min-[800px]:text-[10px] min-[800px]:w-3/4`}>
            ...
            <div className="flex justify-between items-center w-3/5 lg:w-1/3 text-center">
                ...
                <div className={`flex justify-center items-center space-x-1 w-1/4 ${priceColor(oneHourChange)}`}>
                    <div>
                ...
                <div className={`flex justify-center items-center space-x-1 w-1/4 ${priceColor(oneDayChange)}`}>
                    <div>
                ...
                <div className={`flex justify-center items-center space-x-1 w-1/4 ${priceColor(sevenDayChange)}`}>
                    <div>
                        {Number(sevenDayChange) > 0 ?
                            <GreenArrow />
                        :   <RedArrow />}
                    </div>
