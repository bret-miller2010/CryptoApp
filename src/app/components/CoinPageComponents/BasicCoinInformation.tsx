    ...
    return (
        <div className="text-white flex space-x-4 justify-center">
            <div className="space-y-5">
                <div className={`flex flex-col items-center justify-center duration-300 w-[300px] h-[300px] ${textColor(darkMode)} ${secondaryColor(darkMode)} space-y-5 rounded-lg`}>
                ...
                <div className={`flex justify-center items-center duration-300 ${textColor(darkMode)} ${secondaryColor(darkMode)} w-[300px] h-[50px] rounded-lg`}>{link}</div>
            </div>
            <div className={`w-[300px] h-[370px] duration-300 ${secondaryColor(darkMode)} flex justify-center items-center flex-col rounded-lg`}>
