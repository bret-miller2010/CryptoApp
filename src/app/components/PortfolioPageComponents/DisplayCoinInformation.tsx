...
const DisplayCoinInformation = ({ data }) => {
	...
	const { addCoin } = usePortfolioStore((state) => state);
	...
	return (
		<div className={`duration-300 h-screen w-screen ${primaryColor(darkMode)}`}>
			<div className="flex justify-center items-center flex-col">
				<div
					className={`${secondaryColor(darkMode)} ${textColor(darkMode)} w-[800px] h-[300px] flex items-center mt-5 rounded-lg`}
				>
