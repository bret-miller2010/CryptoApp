...
const DisplayCoinInformation = ({ data }) => {
  ...
  return (
    <div
      className={`h-screen w-screen ${darkMode ? "duration-300 bg-[#13121a]" : "duration-300 bg-[#bfbfbf]"}`}
    >
      <div className="flex justify-center items-center flex-col">
        <div
          className={`text-white ${darkMode ? "duration-300 bg-[#181825]" : "duration-300 bg-[#0a5adb]"} w-[800px] h-[300px] flex items-center mt-5 rounded-lg`}
        >
